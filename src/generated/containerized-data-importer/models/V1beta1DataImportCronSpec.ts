...
/**
 * Check if a given object implements the V1beta1DataImportCronSpec interface.
 */
export function instanceOfV1beta1DataImportCronSpec(value: object): value is V1beta1DataImportCronSpec {
    if (!('managedDataSource' in value) || value['managedDataSource'] === undefined) return false;
...
export function V1beta1DataImportCronSpecFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1beta1DataImportCronSpec {
    ...
    return {
        ...
        'garbageCollect': json['garbageCollect'] == null ? undefined : json['garbageCollect'],
        'importsToKeep': json['importsToKeep'] == null ? undefined : json['importsToKeep'],
