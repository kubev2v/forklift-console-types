...
/**
 * Check if a given object implements the V1beta1DataImportCronList interface.
 */
export function instanceOfV1beta1DataImportCronList(value: object): value is V1beta1DataImportCronList {
