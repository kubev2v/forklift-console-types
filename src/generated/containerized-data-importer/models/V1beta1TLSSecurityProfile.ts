...
/**
 * Check if a given object implements the V1beta1TLSSecurityProfile interface.
 */
export function instanceOfV1beta1TLSSecurityProfile(value: object): value is V1beta1TLSSecurityProfile {
    return true;
}
...
export function V1beta1TLSSecurityProfileFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1beta1TLSSecurityProfile {
    ...
    return {
        ...
        'custom': json['custom'] == null ? undefined : V1beta1CustomTLSProfileFromJSON(json['custom']),
        'intermediate': json['intermediate'] == null ? undefined : json['intermediate'],
        'modern': json['modern'] == null ? undefined : json['modern'],
