...
/**
 * Check if a given object implements the V1beta1CustomTLSProfile interface.
 */
export function instanceOfV1beta1CustomTLSProfile(value: object): value is V1beta1CustomTLSProfile {
    if (!('ciphers' in value) || value['ciphers'] === undefined) return false;
    if (!('minTLSVersion' in value) || value['minTLSVersion'] === undefined) return false;
    return true;
}
