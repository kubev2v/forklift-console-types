 ...
 */
export function instanceOfV1ObjectMeta(value: object): value is V1ObjectMeta {
    return true;
}
...
export function V1ObjectMetaFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1ObjectMeta {
    ...
    return {
        ...
        'managedFields': json['managedFields'] == null ? undefined : ((json['managedFields'] as Array<any>).map(V1ManagedFieldsEntryFromJSON)),
        'name': json['name'] == null ? undefined : json['name'],
        'namespace': json['namespace'] == null ? undefined : json['namespace'],
        'ownerReferences': json['ownerReferences'] == null ? undefined : ((json['ownerReferences'] as Array<any>).map(V1OwnerReferenceFromJSON)),
...
export function V1ObjectMetaToJSON(value?: V1ObjectMeta | null): any {
    ...
    return {
        ...
        'labels': value['labels'],
        'managedFields': value['managedFields'] == null ? undefined : ((value['managedFields'] as Array<any>).map(V1ManagedFieldsEntryToJSON)),
        'name': value['name'],
        'namespace': value['namespace'],
        'ownerReferences': value['ownerReferences'] == null ? undefined : ((value['ownerReferences'] as Array<any>).map(V1OwnerReferenceToJSON)),
