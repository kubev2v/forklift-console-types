...
import {
    ...
    IoK8sApiAdmissionregistrationV1alpha1MatchConditionToJSONTyped,
...
import {
    ...
    IoK8sApiAdmissionregistrationV1alpha1MutationToJSONTyped,
} from './IoK8sApiAdmissionregistrationV1alpha1Mutation';
...
import {
    ...
    IoK8sApiAdmissionregistrationV1alpha1MatchResourcesToJSONTyped,
...
import {
    ...
    IoK8sApiAdmissionregistrationV1alpha1ParamKindToJSONTyped,
...
import {
    ...
    IoK8sApiAdmissionregistrationV1alpha1VariableToJSONTyped,
...
/**
 * Check if a given object implements the IoK8sApiAdmissionregistrationV1alpha1MutatingAdmissionPolicySpec interface.
 */
export function instanceOfIoK8sApiAdmissionregistrationV1alpha1MutatingAdmissionPolicySpec(value: object): value is IoK8sApiAdmissionregistrationV1alpha1MutatingAdmissionPolicySpec {
    return true;
}
...
export function IoK8sApiAdmissionregistrationV1alpha1MutatingAdmissionPolicySpecFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiAdmissionregistrationV1alpha1MutatingAdmissionPolicySpec {
    ...
    return {
        ...
        'matchConditions': json['matchConditions'] == null ? undefined : ((json['matchConditions'] as Array<any>).map(IoK8sApiAdmissionregistrationV1alpha1MatchConditionFromJSON)),
        'matchConstraints': json['matchConstraints'] == null ? undefined : IoK8sApiAdmissionregistrationV1alpha1MatchResourcesFromJSON(json['matchConstraints']),
        'mutations': json['mutations'] == null ? undefined : ((json['mutations'] as Array<any>).map(IoK8sApiAdmissionregistrationV1alpha1MutationFromJSON)),
        'paramKind': json['paramKind'] == null ? undefined : IoK8sApiAdmissionregistrationV1alpha1ParamKindFromJSON(json['paramKind']),
        'reinvocationPolicy': json['reinvocationPolicy'] == null ? undefined : json['reinvocationPolicy'],
        'variables': json['variables'] == null ? undefined : ((json['variables'] as Array<any>).map(IoK8sApiAdmissionregistrationV1alpha1VariableFromJSON)),
    };
}

export function IoK8sApiAdmissionregistrationV1alpha1MutatingAdmissionPolicySpecToJSON(json: any): IoK8sApiAdmissionregistrationV1alpha1MutatingAdmissionPolicySpec {
    return IoK8sApiAdmissionregistrationV1alpha1MutatingAdmissionPolicySpecToJSONTyped(json, false);
}

export function IoK8sApiAdmissionregistrationV1alpha1MutatingAdmissionPolicySpecToJSONTyped(value?: IoK8sApiAdmissionregistrationV1alpha1MutatingAdmissionPolicySpec | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'matchConditions': value['matchConditions'] == null ? undefined : ((value['matchConditions'] as Array<any>).map(IoK8sApiAdmissionregistrationV1alpha1MatchConditionToJSON)),
        'matchConstraints': IoK8sApiAdmissionregistrationV1alpha1MatchResourcesToJSON(value['matchConstraints']),
        'mutations': value['mutations'] == null ? undefined : ((value['mutations'] as Array<any>).map(IoK8sApiAdmissionregistrationV1alpha1MutationToJSON)),
        ...
        'variables': value['variables'] == null ? undefined : ((value['variables'] as Array<any>).map(IoK8sApiAdmissionregistrationV1alpha1VariableToJSON)),
    };
}
