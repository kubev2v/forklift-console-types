...
export function IoK8sApimachineryPkgApisMetaV1FieldSelectorRequirementToJSON(json: any): IoK8sApimachineryPkgApisMetaV1FieldSelectorRequirement {
    return IoK8sApimachineryPkgApisMetaV1FieldSelectorRequirementToJSONTyped(json, false);
}

export function IoK8sApimachineryPkgApisMetaV1FieldSelectorRequirementToJSONTyped(value?: IoK8sApimachineryPkgApisMetaV1FieldSelectorRequirement | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
