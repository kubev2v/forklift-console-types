...
/**
 * Check if a given object implements the IoK8sApiResourceV1alpha3DeviceTaint interface.
 */
export function instanceOfIoK8sApiResourceV1alpha3DeviceTaint(value: object): value is IoK8sApiResourceV1alpha3DeviceTaint {
...
export function IoK8sApiResourceV1alpha3DeviceTaintToJSON(json: any): IoK8sApiResourceV1alpha3DeviceTaint {
    return IoK8sApiResourceV1alpha3DeviceTaintToJSONTyped(json, false);
}

export function IoK8sApiResourceV1alpha3DeviceTaintToJSONTyped(value?: IoK8sApiResourceV1alpha3DeviceTaint | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
