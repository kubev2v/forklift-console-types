 ...
 */
export function instanceOfIoK8sApiAutoscalingV2ContainerResourceMetricStatus(value: object): value is IoK8sApiAutoscalingV2ContainerResourceMetricStatus {
...
export function IoK8sApiAutoscalingV2ContainerResourceMetricStatusToJSON(json: any): IoK8sApiAutoscalingV2ContainerResourceMetricStatus {
    return IoK8sApiAutoscalingV2ContainerResourceMetricStatusToJSONTyped(json, false);
}

export function IoK8sApiAutoscalingV2ContainerResourceMetricStatusToJSONTyped(value?: IoK8sApiAutoscalingV2ContainerResourceMetricStatus | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
