...
/**
 * Check if a given object implements the IoK8sApiNetworkingV1beta1ServiceCIDRStatus interface.
 */
export function instanceOfIoK8sApiNetworkingV1beta1ServiceCIDRStatus(value: object): value is IoK8sApiNetworkingV1beta1ServiceCIDRStatus {
    return true;
}
...
export function IoK8sApiNetworkingV1beta1ServiceCIDRStatusToJSON(json: any): IoK8sApiNetworkingV1beta1ServiceCIDRStatus {
    return IoK8sApiNetworkingV1beta1ServiceCIDRStatusToJSONTyped(json, false);
}

export function IoK8sApiNetworkingV1beta1ServiceCIDRStatusToJSONTyped(value?: IoK8sApiNetworkingV1beta1ServiceCIDRStatus | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
