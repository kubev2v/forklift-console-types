...
/**
 * Check if a given object implements the IoK8sApiCertificatesV1beta1ClusterTrustBundleSpec interface.
 */
export function instanceOfIoK8sApiCertificatesV1beta1ClusterTrustBundleSpec(value: object): value is IoK8sApiCertificatesV1beta1ClusterTrustBundleSpec {
...
export function IoK8sApiCertificatesV1beta1ClusterTrustBundleSpecToJSON(json: any): IoK8sApiCertificatesV1beta1ClusterTrustBundleSpec {
    return IoK8sApiCertificatesV1beta1ClusterTrustBundleSpecToJSONTyped(json, false);
}

export function IoK8sApiCertificatesV1beta1ClusterTrustBundleSpecToJSONTyped(value?: IoK8sApiCertificatesV1beta1ClusterTrustBundleSpec | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
