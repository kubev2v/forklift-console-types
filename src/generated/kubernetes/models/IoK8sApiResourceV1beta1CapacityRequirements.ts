 ...
 * @export
 * @interface IoK8sApiResourceV1beta1CapacityRequirements
 */
export interface IoK8sApiResourceV1beta1CapacityRequirements {
     ...
     * @memberof IoK8sApiResourceV1beta1CapacityRequirements
     */
    requests?: { [key: string]: string; };
}

/**
 * Check if a given object implements the IoK8sApiResourceV1beta1CapacityRequirements interface.
 */
export function instanceOfIoK8sApiResourceV1beta1CapacityRequirements(value: object): value is IoK8sApiResourceV1beta1CapacityRequirements {
    return true;
}

export function IoK8sApiResourceV1beta1CapacityRequirementsFromJSON(json: any): IoK8sApiResourceV1beta1CapacityRequirements {
    return IoK8sApiResourceV1beta1CapacityRequirementsFromJSONTyped(json, false);
}

export function IoK8sApiResourceV1beta1CapacityRequirementsFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiResourceV1beta1CapacityRequirements {
    if (json == null) {
        return json;
    }
    return {
...
export function IoK8sApiResourceV1beta1CapacityRequirementsToJSON(json: any): IoK8sApiResourceV1beta1CapacityRequirements {
    return IoK8sApiResourceV1beta1CapacityRequirementsToJSONTyped(json, false);
}

export function IoK8sApiResourceV1beta1CapacityRequirementsToJSONTyped(value?: IoK8sApiResourceV1beta1CapacityRequirements | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
