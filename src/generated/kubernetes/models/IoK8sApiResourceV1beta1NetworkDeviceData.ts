...
/**
 * Check if a given object implements the IoK8sApiResourceV1beta1NetworkDeviceData interface.
 */
export function instanceOfIoK8sApiResourceV1beta1NetworkDeviceData(value: object): value is IoK8sApiResourceV1beta1NetworkDeviceData {
    return true;
}
...
export function IoK8sApiResourceV1beta1NetworkDeviceDataToJSON(json: any): IoK8sApiResourceV1beta1NetworkDeviceData {
    return IoK8sApiResourceV1beta1NetworkDeviceDataToJSONTyped(json, false);
}

export function IoK8sApiResourceV1beta1NetworkDeviceDataToJSONTyped(value?: IoK8sApiResourceV1beta1NetworkDeviceData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
