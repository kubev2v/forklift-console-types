...
/**
 * Check if a given object implements the IoK8sApiResourceV1beta2DeviceConstraint interface.
 */
export function instanceOfIoK8sApiResourceV1beta2DeviceConstraint(value: object): value is IoK8sApiResourceV1beta2DeviceConstraint {
    return true;
}
...
export function IoK8sApiResourceV1beta2DeviceConstraintToJSON(json: any): IoK8sApiResourceV1beta2DeviceConstraint {
    return IoK8sApiResourceV1beta2DeviceConstraintToJSONTyped(json, false);
}

export function IoK8sApiResourceV1beta2DeviceConstraintToJSONTyped(value?: IoK8sApiResourceV1beta2DeviceConstraint | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
