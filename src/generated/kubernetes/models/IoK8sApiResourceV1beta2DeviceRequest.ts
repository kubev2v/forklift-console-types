...
import {
    ...
    IoK8sApiResourceV1beta2DeviceSubRequestToJSONTyped,
} from './IoK8sApiResourceV1beta2DeviceSubRequest';
...
import {
    ...
    IoK8sApiResourceV1beta2ExactDeviceRequestToJSONTyped,
} from './IoK8sApiResourceV1beta2ExactDeviceRequest';
...
/**
 * Check if a given object implements the IoK8sApiResourceV1beta2DeviceRequest interface.
 */
export function instanceOfIoK8sApiResourceV1beta2DeviceRequest(value: object): value is IoK8sApiResourceV1beta2DeviceRequest {
...
export function IoK8sApiResourceV1beta2DeviceRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiResourceV1beta2DeviceRequest {
    ...
    return {
        ...
        'exactly': json['exactly'] == null ? undefined : IoK8sApiResourceV1beta2ExactDeviceRequestFromJSON(json['exactly']),
        'firstAvailable': json['firstAvailable'] == null ? undefined : ((json['firstAvailable'] as Array<any>).map(IoK8sApiResourceV1beta2DeviceSubRequestFromJSON)),
        'name': json['name'],
    };
}

export function IoK8sApiResourceV1beta2DeviceRequestToJSON(json: any): IoK8sApiResourceV1beta2DeviceRequest {
    return IoK8sApiResourceV1beta2DeviceRequestToJSONTyped(json, false);
}

export function IoK8sApiResourceV1beta2DeviceRequestToJSONTyped(value?: IoK8sApiResourceV1beta2DeviceRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'firstAvailable': value['firstAvailable'] == null ? undefined : ((value['firstAvailable'] as Array<any>).map(IoK8sApiResourceV1beta2DeviceSubRequestToJSON)),
        'name': value['name'],
    };
}
