 ...
 */
export function instanceOfIoK8sApiAdmissionregistrationV1beta1NamedRuleWithOperations(value: object): value is IoK8sApiAdmissionregistrationV1beta1NamedRuleWithOperations {
    return true;
}
...
export function IoK8sApiAdmissionregistrationV1beta1NamedRuleWithOperationsToJSON(json: any): IoK8sApiAdmissionregistrationV1beta1NamedRuleWithOperations {
    return IoK8sApiAdmissionregistrationV1beta1NamedRuleWithOperationsToJSONTyped(json, false);
}

export function IoK8sApiAdmissionregistrationV1beta1NamedRuleWithOperationsToJSONTyped(value?: IoK8sApiAdmissionregistrationV1beta1NamedRuleWithOperations | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
