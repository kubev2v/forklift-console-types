 ...
 * @export
 * @interface IoK8sApiResourceV1beta2CapacityRequirements
 */
export interface IoK8sApiResourceV1beta2CapacityRequirements {
     ...
     * @memberof IoK8sApiResourceV1beta2CapacityRequirements
     */
    requests?: { [key: string]: string; };
}

/**
 * Check if a given object implements the IoK8sApiResourceV1beta2CapacityRequirements interface.
 */
export function instanceOfIoK8sApiResourceV1beta2CapacityRequirements(value: object): value is IoK8sApiResourceV1beta2CapacityRequirements {
    return true;
}

export function IoK8sApiResourceV1beta2CapacityRequirementsFromJSON(json: any): IoK8sApiResourceV1beta2CapacityRequirements {
    return IoK8sApiResourceV1beta2CapacityRequirementsFromJSONTyped(json, false);
}

export function IoK8sApiResourceV1beta2CapacityRequirementsFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiResourceV1beta2CapacityRequirements {
    if (json == null) {
        return json;
    }
    return {
...
export function IoK8sApiResourceV1beta2CapacityRequirementsToJSON(json: any): IoK8sApiResourceV1beta2CapacityRequirements {
    return IoK8sApiResourceV1beta2CapacityRequirementsToJSONTyped(json, false);
}

export function IoK8sApiResourceV1beta2CapacityRequirementsToJSONTyped(value?: IoK8sApiResourceV1beta2CapacityRequirements | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
