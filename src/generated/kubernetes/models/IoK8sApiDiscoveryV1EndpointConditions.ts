 ...
 */
export function instanceOfIoK8sApiDiscoveryV1EndpointConditions(value: object): value is IoK8sApiDiscoveryV1EndpointConditions {
    return true;
}
...
export function IoK8sApiDiscoveryV1EndpointConditionsToJSON(json: any): IoK8sApiDiscoveryV1EndpointConditions {
    return IoK8sApiDiscoveryV1EndpointConditionsToJSONTyped(json, false);
}

export function IoK8sApiDiscoveryV1EndpointConditionsToJSONTyped(value?: IoK8sApiDiscoveryV1EndpointConditions | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
