...
/**
 * Check if a given object implements the IoK8sApiResourceV1beta1DeviceRequestAllocationResult interface.
 */
export function instanceOfIoK8sApiResourceV1beta1DeviceRequestAllocationResult(value: object): value is IoK8sApiResourceV1beta1DeviceRequestAllocationResult {
...
export function IoK8sApiResourceV1beta1DeviceRequestAllocationResultToJSON(json: any): IoK8sApiResourceV1beta1DeviceRequestAllocationResult {
    return IoK8sApiResourceV1beta1DeviceRequestAllocationResultToJSONTyped(json, false);
}

export function IoK8sApiResourceV1beta1DeviceRequestAllocationResultToJSONTyped(value?: IoK8sApiResourceV1beta1DeviceRequestAllocationResult | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
