 ...
 * @export
 * @interface IoK8sApiResourceV1beta2DeviceTaintRuleStatus
 */
export interface IoK8sApiResourceV1beta2DeviceTaintRuleStatus {
     ...
     * @memberof IoK8sApiResourceV1beta2DeviceTaintRuleStatus
     */
    conditions?: Array<IoK8sApimachineryPkgApisMetaV1Condition>;
}

/**
 * Check if a given object implements the IoK8sApiResourceV1beta2DeviceTaintRuleStatus interface.
 */
export function instanceOfIoK8sApiResourceV1beta2DeviceTaintRuleStatus(value: object): value is IoK8sApiResourceV1beta2DeviceTaintRuleStatus {
    return true;
}

export function IoK8sApiResourceV1beta2DeviceTaintRuleStatusFromJSON(json: any): IoK8sApiResourceV1beta2DeviceTaintRuleStatus {
    return IoK8sApiResourceV1beta2DeviceTaintRuleStatusFromJSONTyped(json, false);
}

export function IoK8sApiResourceV1beta2DeviceTaintRuleStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiResourceV1beta2DeviceTaintRuleStatus {
    if (json == null) {
        return json;
    }
    return {
...
export function IoK8sApiResourceV1beta2DeviceTaintRuleStatusToJSON(json: any): IoK8sApiResourceV1beta2DeviceTaintRuleStatus {
    return IoK8sApiResourceV1beta2DeviceTaintRuleStatusToJSONTyped(json, false);
}

export function IoK8sApiResourceV1beta2DeviceTaintRuleStatusToJSONTyped(value?: IoK8sApiResourceV1beta2DeviceTaintRuleStatus | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
