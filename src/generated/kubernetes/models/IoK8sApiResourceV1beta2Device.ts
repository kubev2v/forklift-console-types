...
import type { IoK8sApiResourceV1beta2NodeAllocatableResourceMapping } from './IoK8sApiResourceV1beta2NodeAllocatableResourceMapping';
import {
    IoK8sApiResourceV1beta2NodeAllocatableResourceMappingFromJSON,
    IoK8sApiResourceV1beta2NodeAllocatableResourceMappingFromJSONTyped,
    IoK8sApiResourceV1beta2NodeAllocatableResourceMappingToJSON,
    IoK8sApiResourceV1beta2NodeAllocatableResourceMappingToJSONTyped,
} from './IoK8sApiResourceV1beta2NodeAllocatableResourceMapping';
...
import {
    ...
    IoK8sApiResourceV1beta2DeviceCapacityToJSONTyped,
} from './IoK8sApiResourceV1beta2DeviceCapacity';
...
import {
    ...
    IoK8sApiResourceV1beta2DeviceCounterConsumptionToJSONTyped,
} from './IoK8sApiResourceV1beta2DeviceCounterConsumption';
...
import {
    ...
    IoK8sApiResourceV1beta2DeviceAttributeToJSONTyped,
} from './IoK8sApiResourceV1beta2DeviceAttribute';
...
export interface IoK8sApiResourceV1beta2Device {
     ...
     * @type {{ [key: string]: IoK8sApiResourceV1beta2NodeAllocatableResourceMapping; }}
     * @memberof IoK8sApiResourceV1beta2Device
     */
    nodeAllocatableResourceMappings?: { [key: string]: IoK8sApiResourceV1beta2NodeAllocatableResourceMapping; };
    /**
...
/**
 * Check if a given object implements the IoK8sApiResourceV1beta2Device interface.
 */
export function instanceOfIoK8sApiResourceV1beta2Device(value: object): value is IoK8sApiResourceV1beta2Device {
...
export function IoK8sApiResourceV1beta2DeviceFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiResourceV1beta2Device {
    ...
    return {
        ...
        'attributes': json['attributes'] == null ? undefined : (mapValues(json['attributes'], IoK8sApiResourceV1beta2DeviceAttributeFromJSON)),
        ...
        'capacity': json['capacity'] == null ? undefined : (mapValues(json['capacity'], IoK8sApiResourceV1beta2DeviceCapacityFromJSON)),
        'consumesCounters': json['consumesCounters'] == null ? undefined : ((json['consumesCounters'] as Array<any>).map(IoK8sApiResourceV1beta2DeviceCounterConsumptionFromJSON)),
        'name': json['name'],
        'nodeAllocatableResourceMappings': json['nodeAllocatableResourceMappings'] == null ? undefined : (mapValues(json['nodeAllocatableResourceMappings'], IoK8sApiResourceV1beta2NodeAllocatableResourceMappingFromJSON)),
        ...
        'taints': json['taints'] == null ? undefined : ((json['taints'] as Array<any>).map(IoK8sApiResourceV1beta2DeviceTaintFromJSON)),
    };
}

export function IoK8sApiResourceV1beta2DeviceToJSON(json: any): IoK8sApiResourceV1beta2Device {
    return IoK8sApiResourceV1beta2DeviceToJSONTyped(json, false);
}

export function IoK8sApiResourceV1beta2DeviceToJSONTyped(value?: IoK8sApiResourceV1beta2Device | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'attributes': value['attributes'] == null ? undefined : (mapValues(value['attributes'], IoK8sApiResourceV1beta2DeviceAttributeToJSON)),
        ...
        'capacity': value['capacity'] == null ? undefined : (mapValues(value['capacity'], IoK8sApiResourceV1beta2DeviceCapacityToJSON)),
        'consumesCounters': value['consumesCounters'] == null ? undefined : ((value['consumesCounters'] as Array<any>).map(IoK8sApiResourceV1beta2DeviceCounterConsumptionToJSON)),
        'name': value['name'],
        'nodeAllocatableResourceMappings': value['nodeAllocatableResourceMappings'] == null ? undefined : (mapValues(value['nodeAllocatableResourceMappings'], IoK8sApiResourceV1beta2NodeAllocatableResourceMappingToJSON)),
        'nodeName': value['nodeName'],
        'nodeSelector': IoK8sApiCoreV1NodeSelectorToJSON(value['nodeSelector']),
        'taints': value['taints'] == null ? undefined : ((value['taints'] as Array<any>).map(IoK8sApiResourceV1beta2DeviceTaintToJSON)),
    };
}
