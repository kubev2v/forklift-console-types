 ...
 */
export function instanceOfIoK8sApiCoreV1TopologySpreadConstraint(value: object): value is IoK8sApiCoreV1TopologySpreadConstraint {
...
export function IoK8sApiCoreV1TopologySpreadConstraintToJSON(json: any): IoK8sApiCoreV1TopologySpreadConstraint {
    return IoK8sApiCoreV1TopologySpreadConstraintToJSONTyped(json, false);
}

export function IoK8sApiCoreV1TopologySpreadConstraintToJSONTyped(value?: IoK8sApiCoreV1TopologySpreadConstraint | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
