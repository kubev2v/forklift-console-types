...
import {
    ...
    IoK8sApimachineryPkgApisMetaV1OwnerReferenceToJSONTyped,
...
import {
    ...
    IoK8sApimachineryPkgApisMetaV1ManagedFieldsEntryToJSONTyped,
 ...
 */
export function instanceOfIoK8sApimachineryPkgApisMetaV1ObjectMeta(value: object): value is IoK8sApimachineryPkgApisMetaV1ObjectMeta {
    return true;
}
...
export function IoK8sApimachineryPkgApisMetaV1ObjectMetaFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApimachineryPkgApisMetaV1ObjectMeta {
    ...
    return {
        ...
        'managedFields': json['managedFields'] == null ? undefined : ((json['managedFields'] as Array<any>).map(IoK8sApimachineryPkgApisMetaV1ManagedFieldsEntryFromJSON)),
        'name': json['name'] == null ? undefined : json['name'],
        'namespace': json['namespace'] == null ? undefined : json['namespace'],
        'ownerReferences': json['ownerReferences'] == null ? undefined : ((json['ownerReferences'] as Array<any>).map(IoK8sApimachineryPkgApisMetaV1OwnerReferenceFromJSON)),
...
export function IoK8sApimachineryPkgApisMetaV1ObjectMetaToJSON(json: any): IoK8sApimachineryPkgApisMetaV1ObjectMeta {
    return IoK8sApimachineryPkgApisMetaV1ObjectMetaToJSONTyped(json, false);
}

export function IoK8sApimachineryPkgApisMetaV1ObjectMetaToJSONTyped(value?: IoK8sApimachineryPkgApisMetaV1ObjectMeta | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'labels': value['labels'],
        'managedFields': value['managedFields'] == null ? undefined : ((value['managedFields'] as Array<any>).map(IoK8sApimachineryPkgApisMetaV1ManagedFieldsEntryToJSON)),
        'name': value['name'],
        'namespace': value['namespace'],
        'ownerReferences': value['ownerReferences'] == null ? undefined : ((value['ownerReferences'] as Array<any>).map(IoK8sApimachineryPkgApisMetaV1OwnerReferenceToJSON)),
