...
/**
 * Check if a given object implements the IoK8sApiCoreV1AppArmorProfile interface.
 */
export function instanceOfIoK8sApiCoreV1AppArmorProfile(value: object): value is IoK8sApiCoreV1AppArmorProfile {
...
export function IoK8sApiCoreV1AppArmorProfileToJSON(json: any): IoK8sApiCoreV1AppArmorProfile {
    return IoK8sApiCoreV1AppArmorProfileToJSONTyped(json, false);
}

export function IoK8sApiCoreV1AppArmorProfileToJSONTyped(value?: IoK8sApiCoreV1AppArmorProfile | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
