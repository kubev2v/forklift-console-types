 ...
 */
export function instanceOfIoK8sApiAdmissionregistrationV1MutatingWebhook(value: object): value is IoK8sApiAdmissionregistrationV1MutatingWebhook {
...
export function IoK8sApiAdmissionregistrationV1MutatingWebhookToJSON(json: any): IoK8sApiAdmissionregistrationV1MutatingWebhook {
    return IoK8sApiAdmissionregistrationV1MutatingWebhookToJSONTyped(json, false);
}

export function IoK8sApiAdmissionregistrationV1MutatingWebhookToJSONTyped(value?: IoK8sApiAdmissionregistrationV1MutatingWebhook | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
