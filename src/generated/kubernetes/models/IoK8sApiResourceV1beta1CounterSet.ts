...
/**
 * Check if a given object implements the IoK8sApiResourceV1beta1CounterSet interface.
 */
export function instanceOfIoK8sApiResourceV1beta1CounterSet(value: object): value is IoK8sApiResourceV1beta1CounterSet {
...
export function IoK8sApiResourceV1beta1CounterSetToJSON(json: any): IoK8sApiResourceV1beta1CounterSet {
    return IoK8sApiResourceV1beta1CounterSetToJSONTyped(json, false);
}

export function IoK8sApiResourceV1beta1CounterSetToJSONTyped(value?: IoK8sApiResourceV1beta1CounterSet | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
