...
import {
    ...
    IoK8sApiCoreV1ReplicationControllerToJSONTyped,
 ...
 */
export function instanceOfIoK8sApiCoreV1ReplicationControllerList(value: object): value is IoK8sApiCoreV1ReplicationControllerList {
...
export function IoK8sApiCoreV1ReplicationControllerListToJSON(json: any): IoK8sApiCoreV1ReplicationControllerList {
    return IoK8sApiCoreV1ReplicationControllerListToJSONTyped(json, false);
}

export function IoK8sApiCoreV1ReplicationControllerListToJSONTyped(value?: IoK8sApiCoreV1ReplicationControllerList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
