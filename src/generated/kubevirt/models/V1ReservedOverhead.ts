 ...
 */
export function instanceOfV1ReservedOverhead(value: object): value is V1ReservedOverhead {
    return true;
}
...
export function V1ReservedOverheadFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1ReservedOverhead {
    ...
    return {
        ...
        'addedOverhead': json['addedOverhead'] == null ? undefined : json['addedOverhead'],
        'memLock': json['memLock'] == null ? undefined : json['memLock'],
    };
}

export function V1ReservedOverheadToJSON(json: any): V1ReservedOverhead {
    return V1ReservedOverheadToJSONTyped(json, false);
}

export function V1ReservedOverheadToJSONTyped(value?: V1ReservedOverhead | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
