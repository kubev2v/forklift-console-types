 ...
 */
export function instanceOfV1beta1CPUPreferences(value: object): value is V1beta1CPUPreferences {
    return true;
}
...
export function V1beta1CPUPreferencesFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1beta1CPUPreferences {
    ...
    return {
        ...
        'preferredCPUFeatures': json['preferredCPUFeatures'] == null ? undefined : ((json['preferredCPUFeatures'] as Array<any>).map(V1CPUFeatureFromJSON)),
...
export function V1beta1CPUPreferencesToJSON(json: any): V1beta1CPUPreferences {
...
export function V1beta1CPUPreferencesToJSONTyped(value?: V1beta1CPUPreferences | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'preferredCPUFeatures': value['preferredCPUFeatures'] == null ? undefined : ((value['preferredCPUFeatures'] as Array<any>).map(V1CPUFeatureToJSON)),
