 ...
 */
export function instanceOfV1VirtualMachineInstanceMigrationSource(value: object): value is V1VirtualMachineInstanceMigrationSource {
    if (!('connectURL' in value) || value['connectURL'] === undefined) return false;
...
export function V1VirtualMachineInstanceMigrationSourceToJSON(json: any): V1VirtualMachineInstanceMigrationSource {
    return V1VirtualMachineInstanceMigrationSourceToJSONTyped(json, false);
}

export function V1VirtualMachineInstanceMigrationSourceToJSONTyped(value?: V1VirtualMachineInstanceMigrationSource | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
