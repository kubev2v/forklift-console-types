 ...
 */
export function instanceOfV1beta1VirtualMachineRestoreList(value: object): value is V1beta1VirtualMachineRestoreList {
...
export function V1beta1VirtualMachineRestoreListToJSON(json: any): V1beta1VirtualMachineRestoreList {
