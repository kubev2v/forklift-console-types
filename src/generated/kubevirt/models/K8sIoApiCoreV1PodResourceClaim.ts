 ...
 */
export function instanceOfK8sIoApiCoreV1PodResourceClaim(value: object): value is K8sIoApiCoreV1PodResourceClaim {
...
export function K8sIoApiCoreV1PodResourceClaimToJSON(json: any): K8sIoApiCoreV1PodResourceClaim {
    return K8sIoApiCoreV1PodResourceClaimToJSONTyped(json, false);
}

export function K8sIoApiCoreV1PodResourceClaimToJSONTyped(value?: K8sIoApiCoreV1PodResourceClaim | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
