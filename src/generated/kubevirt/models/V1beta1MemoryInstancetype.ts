 ...
 */
export function instanceOfV1beta1MemoryInstancetype(value: object): value is V1beta1MemoryInstancetype {
...
export function V1beta1MemoryInstancetypeToJSON(json: any): V1beta1MemoryInstancetype {
