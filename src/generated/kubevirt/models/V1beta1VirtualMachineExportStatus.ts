...
import {
    ...
    V1beta1VirtualMachineExportLinksToJSONTyped,
 ...
 */
export function instanceOfV1beta1VirtualMachineExportStatus(value: object): value is V1beta1VirtualMachineExportStatus {
    return true;
}
...
export function V1beta1VirtualMachineExportStatusToJSON(json: any): V1beta1VirtualMachineExportStatus {
