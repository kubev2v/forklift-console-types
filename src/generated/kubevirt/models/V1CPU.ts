 ...
 */
export function instanceOfV1CPU(value: object): value is V1CPU {
    return true;
}
...
export function V1CPUFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1CPU {
    ...
    return {
        ...
        'features': json['features'] == null ? undefined : ((json['features'] as Array<any>).map(V1CPUFeatureFromJSON)),
...
export function V1CPUToJSON(json: any): V1CPU {
...
export function V1CPUToJSONTyped(value?: V1CPU | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'features': value['features'] == null ? undefined : ((value['features'] as Array<any>).map(V1CPUFeatureToJSON)),
