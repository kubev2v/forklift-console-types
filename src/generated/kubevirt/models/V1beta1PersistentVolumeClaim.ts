 ...
 */
export function instanceOfV1beta1PersistentVolumeClaim(value: object): value is V1beta1PersistentVolumeClaim {
    return true;
}
...
export function V1beta1PersistentVolumeClaimToJSON(json: any): V1beta1PersistentVolumeClaim {
